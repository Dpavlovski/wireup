export default function CopyButton({handleCopy}) {
    return (
        <button onClick={handleCopy} className="copy-button">
            <span className="copy-button-text">Copy</span>
            <span className="copy-button-svgIcon">
    <svg fill="white" viewBox="0 0 384 512" height="1em" xmlns="http://www.w3.org/2000/svg"><path
